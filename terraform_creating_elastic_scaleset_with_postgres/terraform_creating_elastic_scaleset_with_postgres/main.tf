...
resource "azurerm_public_ip" "LoadBalacerPublicIp" {
  ...
  sku                 = "Standard"
  domain_name_label            = "thisisexampleofdomainofscaleset" #my edit
...
/*----------------------------------------------------------------------------------------*/
# /*Configuring the load balancer inbound rule to allow outside access to the load balancer(Like a NSG)*/
/*----------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------*/
#PROBE BLOCK REQUIRED FOR THE OPERATION OF LOAD BALANCER
/*----------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------*/
#Poll for Scale set "elastic" infrastructure
...
module "Scale_set_module" {
  ...
  pg_host                                     = azurerm_postgresql_flexible_server.PosrgreSQLFlexibleDataServer.name /*"{name}}.postgres.database.azure.com"*/
